...
function handleDecay() {
    ...
    const loveDecayCount = Math.floor(loveDecayTime / LOVE_DECAY_INTERVAL_MINUTES);
    const hungerDecayCount = Math.floor(hungerDecayTime / HUNGER_DECAY_INTERVAL_MINUTES);
