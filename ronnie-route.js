...
class RonnieRoute {
    ...
    act2Beat2_laugh() {
        this.game.displayScene({
            ...
            dialogue: '"Refined palate, huh? Watch Ã¢â‚¬â€ one scoop."',
    ...
    act2Beat2_resume() {
        this.game.displayScene({
            ...
            dialogue: '"Ã¢â‚¬â€candy. That\'s what makes it fun! Are you even listening?"',
            choices: [
    ...
    act2Beat3_end() {
        this.game.displayScene({
            ...
            internal: '[ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â¡ Setup: This sprite becomes the visual marker for Digital Forever ending Ã¢â‚¬â€ she\'ll recognize him by the "bad nose."]\n[Tone: Pure warmth, no glitch. Valley of safety.]',
            next: () => this.act2Beat4(),
            delay: 5000
        });
    }
    ...
    act2Beat6_freeze(choice) {
        ...
        this.game.displayScene({
            character: 'Tori (laughing)',
            dialogue: response,
            internal: '[ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â¡ Freeze mid-laugh Ã¢â‚¬â€ System dialogue box flickers.]',
            systemMessage: 'Feed me? Clean up?',
    ...
    act2Beat8_toriPain() {
        this.game.displayScene({
            ...
            choices: [
                { text: '(Desperate) "Hold on Ã¢â‚¬â€ if I upload you online, it\'ll hold you stronger!"', value: 'upload' },
    ...
    act2Beat8_outcome(choice) {
        ...
        if (choice === 'upload') {
            // Bad Route Tilt
            dialogue = '"Local save isn\'t enough. I\'ll push you online Ã¢â‚¬â€ bigger servers, stronger walls!"\n[Upload bar UI: 32% ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ 56% ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ 100%]\n"There! You\'re safe nowÃ¢â‚¬â€"\n\n[Tori (weak, glitching): "...Ronnie... I\'m still stuck. You can\'t... upload a soul."]';
    ...
    act3Beat1_hospital() {
        this.game.displayScene({
            ...
            dialogue: '"The hospital. The call. You wereÃ¢â‚¬â€"',
    ...
    badRoute_news() {
        this.game.displayScene({
            ...
            dialogue: '"Ã¢â‚¬â€breakthrough in temporal displacement technology announced todayÃ¢â‚¬â€"',
    ...
    badRoute_apology() {
        this.game.displayScene({
            character: 'Tori',
            dialogue: '"Oh my gosh, I\'m so sorryÃ¢â‚¬â€I wasn\'t paying attention!"',
    ...
    digitalForever_excuse() {
        this.game.displayScene({
            ...
            dialogue: '"Excuse meÃ¢â‚¬â€it\'s MY hoodie."',
    ...
    trueRoute_transfer() {
        this.game.displayScene({
            ...
            dialogue: '"I feel it... the pull... I\'mÃ¢â‚¬â€"',
    ...
    trueRoute_ronnieJoke() {
        this.game.displayScene({
            character: 'Ronnie',
            dialogue: '"Thought I\'d try it out. It\'s getting colder out. Keeps my face warm ðŸ˜œ Plus I\'ll look like Santa if I put the hat on."',
    ...
    trueRoute_dejavu() {
        this.game.displayScene({
            ...
            dialogue: '"...Weird. DÃ©jÃ  vu, I guess."',
