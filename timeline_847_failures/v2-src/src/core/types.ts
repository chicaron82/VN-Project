...
export type EffectType =
  ...
  | 'haptic'
  // V1 Visual Cues
  | 'bodyHop' // Tori body hop flicker
  | 'tetherPull' // Inward squeeze effect
  | 'denialShake' // Gentle "no" shake
  | 'harshDenial' // Screen tilt for lockouts
  | 'timelineGlitch' // Reality distortion
  | 'chromaticSplit' // RGB split overlay
  | 'emergencyFlash'; // Red warning pulse
