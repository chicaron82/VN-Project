 ...
 * Complete collection of all methodology sections (expandable cards)
 *
 * Sections:
 * 1. Blind Peer Review Process
 * 2. Cognitive Diversity Arbitrage
 * 3. Reality Check: Tradeoffs & Freedom
 * 4. AI Fingerprints in Code
 * 5. Recipe vs Ingredients
 * 6. The MasterChef Cycle
 * 7. V3 Experiment (callout, not expandable)
...
export class MethodologyAccordion {
    render(): string {
        return `
            <div class="methodology-deep-dives">

                <!-- 1. Blind Peer Review -->
                ${this.renderBlindPeerReview()}

                <!-- 2. Cognitive Diversity (Parallel Development) -->
                ${this.renderCognitiveDiversity()}

                <!-- 3. Reality Check -->
                ${this.renderRealityCheck()}

                <!-- 4. AI Fingerprints -->
                ${this.renderAIFingerprints()}

                <!-- 5. Recipe vs Ingredients -->
                ${this.renderRecipeVsIngredients()}

                <!-- 6. The MasterChef Cycle -->
                ${this.renderMasterChefCycle()}

                <!-- 7. The V3 Experiment (Special Callout) -->
                ${this.renderV3Experiment()}

                <!-- 8. V1 vs V2: Soma's Journey -->
                ${this.renderSomaJourney()}

            </div>
        `;
    }

    private renderBlindPeerReview(): string {
        return `
    ...
    private renderCognitiveDiversity(): string {
        return `
    ...
    private renderRealityCheck(): string {
        return `
    ...
    private renderAIFingerprints(): string {
        return `
            <div class="methodology-expandable">
...
private maxBackups: number = 2;</code></pre>
    ...
    private renderRecipeVsIngredients(): string {
        return `
            <div class="methodology-expandable">
    ...
    private renderMasterChefCycle(): string {
        return `
            <div class="methodology-expandable">
    ...
    private renderV3Experiment(): string {
        return `
    ...
    private renderSomaJourney(): string {
        return `
            <div class="methodology-expandable">
