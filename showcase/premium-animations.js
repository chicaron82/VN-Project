...
(function () {
    ...
    function initRippleEffects() {
        const buttons = document.querySelectorAll('button, .btn, .card.clickable');
    ...
    function initTimelineMarkers() {
        ...
        markers.forEach(marker => {
            ...
            marker.addEventListener('click', (e) => {
                ...
                if (timelineItem) {
                    const toggle = timelineItem.querySelector('.expand-toggle');
    ...
    function initCardHovers() {
        ...
        const cards = document.querySelectorAll('.card, .technical-card, .crew-card');
