...
import type { NotePreview } from './NotificationShadeTypes';
import { createShadeDOM } from './NotificationShadeDOM';

// Re-export types for backward compatibility
export type { NotePreview } from './NotificationShadeTypes';
 ...
 *
 * DOM template delegated to NotificationShadeDOM.ts
 * Types defined in NotificationShadeTypes.ts
 */
...
export class NotificationShade {
    ...
    private createDOM(): HTMLElement {
        return createShadeDOM(this.isInShell);
    }
