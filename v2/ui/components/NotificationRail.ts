...
export type NotificationCategory = 'system' | 'torigatchi' | 'achievement' | 'autosave' | 'tether' | 'note' | 'app';
...
// Default notification durations by priority
...
const PRIORITY_COLORS: Record<NotificationPriority, { border: string; glow: string; bg: string }> = {
    urgent: {
