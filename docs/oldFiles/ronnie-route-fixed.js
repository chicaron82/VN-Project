...
class RonnieRoute {
    ...
    act2Beat2_laugh() {
        this.game.displayScene({
            ...
            dialogue: '"Refined palate, huh? Watch — one scoop."',
    ...
    act2Beat2_resume() {
        this.game.displayScene({
            ...
            dialogue: '"—candy. That\'s what makes it fun! Are you even listening?"',
            choices: [
    ...
    act2Beat3_end() {
        this.game.displayScene({
            ...
            internal: '[ðŸ’¡ Setup: This sprite becomes the visual marker for Digital Forever ending — she\'ll recognize him by the "bad nose."]\n[Tone: Pure warmth, no glitch. Valley of safety.]',
            next: () => this.act2Beat4(),
            delay: 5000
        });
    }
    ...
    act2Beat6_freeze(choice) {
        ...
        this.game.displayScene({
            character: 'Tori (laughing)',
            dialogue: response,
            internal: '[ðŸ’¡ Freeze mid-laugh — System dialogue box flickers.]',
            systemMessage: 'Feed me? Clean up?',
    ...
    act2Beat8_toriPain() {
        this.game.displayScene({
            ...
            choices: [
                { text: '(Desperate) "Hold on — if I upload you online, it\'ll hold you stronger!"', value: 'upload' },
    ...
    act3Beat1_hospital() {
        this.game.displayScene({
            ...
            dialogue: '"The hospital. The call. You were—"',
    ...
    digitalForever_excuse() {
        this.game.displayScene({
            ...
            dialogue: '"Excuse me—it\'s MY hoodie."',
