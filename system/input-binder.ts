...
class InputBinder {
    ...
    bindSaveLoad() {
        ...
        // Deletes
        this.bindClick('btn-delete-slot-1', (e: Event) => { e.stopPropagation(); this.game.deleteSaveSlot(1); });
        this.bindClick('btn-delete-slot-2', (e: Event) => { e.stopPropagation(); this.game.deleteSaveSlot(2); });
        this.bindClick('btn-delete-slot-3', (e: Event) => { e.stopPropagation(); this.game.deleteSaveSlot(3); });
    }
    ...
    bindClick(id: string, handler: (e: Event) => void): void {
...
if (typeof window !== 'undefined') {
    (window as any).InputBinder = InputBinder;
}
