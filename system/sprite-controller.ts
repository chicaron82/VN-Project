...
declare class GameEngine {
    ...
    currentSprites: { left: string | null; right: string | null };
    gameState: any;
    sceneRenderer: any;
    currentEchoGrowthStage: string | null;
    [key: string]: any;
}

/** Scene data for positioning */
interface SceneData {
    character?: string;
    [key: string]: any;
}
...
if (typeof window !== 'undefined') {
    (window as any).SpriteController = SpriteController;
}
