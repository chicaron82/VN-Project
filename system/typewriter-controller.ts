...
class TypewriterController {
    ...
    typewriterInterval: ReturnType<typeof setInterval> | null;
    typewriterCallback: (() => void) | null;
    fullDialogueText: string;
    paginationActive: boolean;
    dialoguePages: string[];
    currentDialoguePage: number;
...
if (typeof window !== 'undefined') {
    (window as any).TypewriterController = TypewriterController;
}
