...
declare class GameEngine {
    ...
    tetherUI: HTMLElement;
    holdOnButton: HTMLElement | null;
    saveLoadUI: any;
    collectiblesManager: any;
    notesCount: HTMLElement | null;
    triggerSensoryFeedback: (type: string, element: any, message?: string) => void;
    updateTitleScreen: () => void;
    setDialogueFrame: (style: string) => void;
    deactivateInsaneMode: () => void;
    [key: string]: any;
}

/** Route classes */
declare class RonnieRoute {
    constructor(game: GameEngine);
    [key: string]: any;
}
declare class ToriRoute {
    constructor(game: GameEngine);
    [key: string]: any;
}
...
class SaveManager {
    ...
    restoreCollectedNotes(route, noteIds) {
        ...
        if (this.game.notesCount) {
            this.game.notesCount.textContent = totalNotes.toString();
        }
    }
