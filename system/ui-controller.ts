...
declare const OverlayManager: {
    createError(title: string, message: string, options?: any): HTMLElement;
    createConfirm(title: string, message: string, onConfirm: Function, options?: any): HTMLElement;
    createWarning(title: string, message: string, options?: any): HTMLElement;
    createInfo(title: string, message: string, options?: any): HTMLElement;
    show(overlay: HTMLElement): void;
    hide(id: string, remove?: boolean): void;
    [key: string]: any;
};

/** Extended Document for vendor-prefixed fullscreen */
interface Document {
